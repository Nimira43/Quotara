  ...
  return (
    <div className='px-6 py-16 max-w-4xl mx-auto space-y-20'>
      ...
      <section className='text-center space-y-6'>
        ...
        <p className='text-teal-700 text-lg leading-relaxed border border-orange-400 px-6 py-6 rounded-xl shadow-md bg-teal-50'>
      ...
      <section className='text-center space-y-6'>
        ...
        <p className='text-teal-700 leading-relaxed border border-orange-400 px-6 py-6 rounded-xl shadow-md bg-teal-50'>
