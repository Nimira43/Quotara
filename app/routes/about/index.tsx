  ...
  return (
    <div className='px-6 py-16 max-w-4xl mx-auto space-y-20'>
      ...
      <section className='text-center space-y-6'>
        <h1 className='text-4xl font-bold text-orange-400 inline-block border border-orange-400 px-4 py-2 rounded-2xl shadow-md bg-teal-50'>
          About Quotara
        </h1>
        <p className='text-teal-700 text-lg leading-relaxed border border-teal-700 px-6 py-6 rounded-xl shadow-md bg-teal-50'>
      ...
      <section className='text-center space-y-6'>
        <h2 className='text-2xl font-semibold text-orange-400 border border-orange-400 bg-teal-50 inline-block px-4 py-2 rounded-2xl shadow-md'>
          Why We Built Quotara
        </h2>
        <p className='text-teal-700 leading-relaxed border border-teal-700 px-6 py-6 rounded-xl shadow-md bg-teal-50'>
      ...
      <section className='text-center space-y-6'>
        <h2 className='text-2xl font-semibold text-orange-400 border border-orange-400 inline-block px-4 py-2 rounded-2xl shadow-md bg-teal-50'>
